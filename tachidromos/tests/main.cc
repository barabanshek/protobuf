...
tachidromos::tests::RepeatedMessage InitializeRepeatedMessage() {
    ...
    repeated_message.add_int_fields(1);
    repeated_message.add_int_fields(2);
    repeated_message.add_int_fields(3);
    auto* repeated_nested_message = repeated_message.add_nested_messages();
    repeated_nested_message->set_nested_string("World");
    repeated_nested_message->set_nested_int(789);
...
int main(int argc, char* argv[]) {
    ...
    if (argc > 1 && std::string(argv[1]) == "ri") {
